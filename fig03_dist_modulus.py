...
def distance_modulus(Hfunc):
    """Return μ(z) using proper integral for the given E(z)."""
...
print(f"RMS Δμ  (scalar-time integr. vs toy)  = {rms_st:.4f} mag")
print(f"RMS Δμ  (ΛCDM       integr. vs toy)  = {rms_LCDM:.4f} mag")
